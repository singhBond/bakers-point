...
export const CategorySidebar: React.FC<Props> = ({
  ...
  return (
    <aside className="w-24 sm:w-40 md:w-60 sticky top-28 h-[calc(100vh-8rem)] overflow-y-auto bg-linear-to-r from-orange-300 via-yellow-50 to-orange-300 border-r rounded-xl shadow-sm p-2 scrollbar-thin">
